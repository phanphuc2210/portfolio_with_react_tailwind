...
export default function Home() {
  ...
  return (
    <div className={darkMode ? 'dark' : ''}>
      <Head>
        <title>PhanPhuc Portfolio</title>
      ...
      <main className='bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900'>
        <section className=' min-h-screen'>
          <nav className='py-10 mb-12 flex justify-between'>
            <h1 className='text-xl font-burtons dark:text-white'>phanphuc2210</h1>
          ...
          <div className='text-center p-10'>
            ...
            <p className='text-base py-5 leading-8 text-gray-800 md:text-xl max-w-xl mx-auto dark:text-gray-300'>
              ...
              needs. Join me down below and let&rsquo;s get cracking!
            </p>
          </div>
          ...
          <div className='relative mx-auto bg-gradient-to-b from-teal-500 rounded-full w-80 h-80 mt-20 overflow-hidden md:h-96 md:w-96'>
            <Image src={deved} layout='fill' objectFit='cover' alt='a man'/>
          </div>
        </section>
        ...
        <section>
          <div>
            ...
            <p className='text-base py-2 leading-8 text-gray-800 dark:text-gray-300'>
          ...
          <div className='lg:flex gap-10'>
            ...
            <div className='text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white'>
              ...
              <p className='py-2'>
                Do you have an idea for your next great website? Let&rsquo;s make it a
                reality.
              </p>
              <h4 className='py-4 text-teal-600'>Design tools I use</h4>
              <p className='text-gray-800 py-1'>Photoshop</p>
